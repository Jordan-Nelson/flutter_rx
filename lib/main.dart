          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                RaisedButton(
                  onPressed: () {
                    store.dispatch(ChangeCounterByValueAction(value: -5));
                  },
                  child: Text('-5'),
                ),
                Container(width: 8),
              ...
              child: Row(
                children: <Widget>[
                  Expanded(
                    child: RaisedButton(
                      onPressed: () {
                        store.dispatch(DelayedIncrementCounterAction());
                      },
                      child: Text('Delayed Increment'),
                    ),
                  ),
                ],
              ),
              ...
              child: Row(
                children: <Widget>[
                  Expanded(
                    child: RaisedButton(
                      onPressed: () {
                        store.dispatch(ReadLocalStorageCounterAction());
                      },
